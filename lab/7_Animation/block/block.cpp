...
void SetupRC()
{
	...
	Mat image = imread("D:/program/cg-hw/hw7/block/floor.jpg");
	if (image.empty()) {
		cout << "no image" << endl;
	}
	glBindTexture(GL_TEXTURE_2D, textures[0]);
	...
	image = imread("D:/program/cg-hw/hw7/block/Block4.jpg");
	if (image.empty()) {
		cout << "no image" << endl;
	}
	glBindTexture(GL_TEXTURE_2D, textures[1]);
	...
	image = imread("D:/program/cg-hw/hw7/block/Block5.jpg");
	if (image.empty()) {
		cout << "no image" << endl;
	}
	glBindTexture(GL_TEXTURE_2D, textures[2]);
	...
	image = imread("D:/program/cg-hw/hw7/block/Block6.jpg");
	if (image.empty()) {
		cout << "no image" << endl;
	}
	glBindTexture(GL_TEXTURE_2D, textures[3]);
