...
class GLFrame
    ...
    public:
        ...
        inline void SetForwardVector(const GLfloat vDirection[3]) {
        ...
        inline void GetForwardVector(GLfloat vVector[3]) { m3dCopyVector3(vVector, vForward); }
